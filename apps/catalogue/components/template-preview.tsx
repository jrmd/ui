"use client";import {lazy,Suspense} from 'react';const T_saas=lazy(()=>import('../../../templates/saas/app/view').then(m=>({default:m.TemplateView})));
