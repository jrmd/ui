...
export type TerrainHeroOptions = Pick<
  HeroProps,
  | "title"
  | "description"
  | "actionLabel"
  ...
  | "href"
>;
export type TerrainHeroProps = Omit<
...
export function TerrainHeroHeader({
  className,
  ...props
}: React.ComponentProps<"div">) {
  return (
    <div
      data-slot="terrain-hero-header"
      className={cn(
...
export function TerrainHeroContent({
  className,
  ...props
}: React.ComponentProps<"div">) {
  return (
    <div
      data-slot="terrain-hero-content"
      className={cn(
...
export function TerrainHeroTitle({
  className,
  ...props
}: React.ComponentProps<"h1">) {
  return (
    <h1
      data-slot="terrain-hero-title"
      className={cn(
